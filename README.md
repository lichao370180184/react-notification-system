...
| image        | string          | null      | Adds an image with the given URL as source
| imageHeight  | integer         | 65l       | Image height (in pixels)
| imageWidth   | integer         | 65l       | Image width (in pixels)
